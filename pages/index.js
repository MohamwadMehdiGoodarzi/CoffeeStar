              ...
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center flex-wrap ">
                    <bottun className="bg-sky-500 hover:bg-sky-800 transition-all cursor-pointer text-white px-4 py-1.5 rounded-lg inline-flex items-center md:mb-2 lg:mb-0">Learn More
