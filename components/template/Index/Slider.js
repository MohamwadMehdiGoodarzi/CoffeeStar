      ...
      <div className="container md:px-6 md:py-7 mx-auto">
        <div className="lg:flex lg:items-center lg:gap-10">
          ...
          <div className="lg:w-1/2 mt-8 lg:mt-0 px-2.5 md:px-0">
            <h1 className="text-2xl font-DanaDemiBold text-gray-800 dark:text-white lg:text-4xl"> انواع قـهوه عربیکا و روبوستا و مواد اولیه کافـی شاپ </h1>
            <p className="max-w-lg text-lg mt-6 text-gray-500 dark:text-gray-300"> Genio یک روستر قهوه تخصصی 15 کیلوگرمی است که برای برشته‌کاری‌هایی ایده‌آل است که برای همگام شدن با تجارت در حال گسترش خود به ظرفیت تولید بیشتری نیاز دارند. پایداری کامل دارد و می تواند 60 کیلوگرم قهوه را در ساعت برشته کند. </p>
            <h3 className="mt-6 text-xl font-DanaMedium text-blue-500">فروشگاه و رُستری قهوه به کافی</h3>
